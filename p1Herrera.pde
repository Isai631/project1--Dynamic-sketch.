...
dy= random(-1, +1);
xGold= random(20, width-20);     // Move gold to random spot
yGold= random(horizon+20, height-20);
}
...
void show() {
 ...
 ellipse( x+25,y+25, 30, 60 );                 // white creature
  ...
  fill(random(150,200), 150, random(0,100));
  ellipse(xGold, yGold, 50, 20);
}
